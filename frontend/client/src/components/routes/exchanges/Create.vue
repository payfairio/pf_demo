...
<script>
    export default {
        ...
        created: function(){
            if (this.manage){
                const vm = this;
                this.$http.get('/exchanges/' + this.$props['id']).then(function (response){
        ...
        methods: {
            onSubmit: function (e) {
                ...
                if (this.manage){
                    ...
                    this.$http.post('/exchanges/edit/' + this.id, exch).then(function (response) {
            ...
            closeExch: function(e){
                e.preventDefault;
                const vm = this;
                this.$http.post('/exchanges/close', {id: this.id}).then(function (response){
